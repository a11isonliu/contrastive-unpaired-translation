...
def tensor2im(input_image, imtype=np.float64):
    ...
    print('shape: ', np.shape(image_numpy), 'max: ', np.max(image_numpy), 'min: ', np.min(image_numpy))
...
def save_image(image_numpy, image_path, aspect_ratio=1.0, magnetogram = True):
